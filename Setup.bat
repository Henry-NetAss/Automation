...
echo powershell.exe C:\NA\Installation\RemoveCapabilities.ps1
echo powershell.exe C:\NA\Installation\Removefeatures.ps1
echo powershell.exe C:\NA\Installation\RemovePackages.ps1
echo powershell.exe C:\NA\Installation\UserOnce.ps1
