...
copy-item -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Outlook (Classic).lnk" -Destination "$env:USERPROFILE\Desktop\Outlook (Classic).lnk" -Recurse -Force
